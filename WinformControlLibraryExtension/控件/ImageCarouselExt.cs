    ...
    public class ImageCarouselExt : Control
    {
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                if (this.NavigationBarShowType != NavigationBarShowTypes.None)
                {
                    ...
                    {
                        isfind = true;
                        this.currentMouseDownObject = this.navigationBar.pre_btn;
                        goto result;
                    }
                    if (this.navigationBar.next_btn.btn_rectf.Contains(point))
                    {
                        isfind = true;
                        this.currentMouseDownObject = this.navigationBar.next_btn;
                        goto result;
                    }
                }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                {
                    Point point = this.PointToClient(Control.MousePosition);
                    if (this.navigationBar.pre_btn.btn_rectf.Contains(point) && this.currentMouseDownObject == this.navigationBar.pre_btn)
                    {
                    ...
                    else if (this.navigationBar.next_btn.btn_rectf.Contains(point) && this.currentMouseDownObject == this.navigationBar.next_btn)
                    {
